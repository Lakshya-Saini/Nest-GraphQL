...
import { Author, AuthorDocument, CreateAuthorInput, FindAuthorInput, UpdateAuthorInput } from './author.schema';
...
export class AuthorsService {
  ...
  async updateAuthor(id: string, params: UpdateAuthorInput) {
    ...
    const author = await this.authorModel.updateOne({ _id: id }, { ...params, $push: { bookIds: { $each: bookIds } } }).exec();
