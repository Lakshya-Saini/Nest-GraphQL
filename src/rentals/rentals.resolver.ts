...
import { CreateRentalInput, FindRentalInput, Rental } from './rental.schema';
...
export class RentalsResolver {
  constructor(private readonly rentalService: RentalsService, private userService: UsersService, private bookService: BooksService) {}
