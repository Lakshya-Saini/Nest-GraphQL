...
import { CreateUserInput, FindUserInput, UpdateUserInput, User, UserDocument } from './users.schema';
...
export class UsersService {
  ...
  async updateUser(id: string, params: UpdateUserInput) {
    ...
    const user = await this.userModel.updateOne({ _id: id }, { ...params, $push: { rentalIds: { $each: rentalIds } } }).exec();
